...
<body>
 <a href="loginru.php" style="border-radius:50%;border:1px solid aqua; background:navy;"> <img src="png/ru.png" style="width:2em;height:2em;border-radius:50%;box-shadow:1px 1px 18px silver; border:2px solid aqua"></a>
