...
if(isset($_POST['getlink'])) 
{
 ...
 echo $headers = "From: " . $admnmail;
  ...
  echo '<div id="successrs" class="alert alert-success notifycross" style="display:none;color:green;border-radius:5px; border-right:15px solid green;background:rgba(189,255,189,0.861);font-size:1.5em; box-shadow:1px 1px 10px green;" role="alert"> Вам отправлено электронное письмо Пожалуйста, проверьте его или в спаме и откройте ссылку в течение одной минуты для сброса.
    </div>';
  }
}
...
<ul>
<li>
<a href="../../en/password/reset.php" class="en">en</a>
</li>
</ul>
</div>
<div class="auth-btn">
